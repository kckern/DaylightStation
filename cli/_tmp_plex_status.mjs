...
async function main() {
  ...
  console.log('active Plex activities:', acts.length);
  for (const a of acts) console.log(' -', a.type, a.title, a.subtitle, a.progress + '%');
  ...
  console.log('\nS1E1 now:', JSON.stringify({title: first.title, summary: first.summary, updatedAt: first.updatedAt}));
}
