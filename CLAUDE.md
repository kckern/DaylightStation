...
| School word ladder (vocabulary word packages, any language — Korean is the example: lexicon decks, per-word ladder, review run, printed quiz fold) | `docs/reference/school/word-ladder.md` |
