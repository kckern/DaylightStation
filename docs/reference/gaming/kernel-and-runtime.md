...
`GameSessionHeader` is the durable identity: protocol version, session ID, lifecycle status, pinned ruleset reference/version/hash, revision, unsigned seed, participants, and seats.
