...
**The consequence for Task 9, which does ship:** until glosses exist there is no partial
hint on interpretation — only the reveal. Do not draw a Hint control that has nothing to
say.
