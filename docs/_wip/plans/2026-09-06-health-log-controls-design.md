...
After a successful commit offer Undo using current returned versions; never silently overwrite concurrent edits. Failed commands keep their draft and existing retry/rebase behavior. Cross-date saves cannot resurrect old drafts.
