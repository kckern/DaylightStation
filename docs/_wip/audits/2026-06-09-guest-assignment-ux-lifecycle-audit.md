...
- ⚠️ **No feedback about data attribution.** The threshold rule means a sub-5-min wrong segment will be absorbed — genuinely great behavior — but the UI never says "Soren's last 3 minutes will transfer to Guest." Hosts who know the old 60s rule still rush; hosts who don't know any rule worry they've lost data. Silent correctness reads as uncertainty.
