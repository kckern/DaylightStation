// backend/tests/unit/applications/concierge/policy-integration.test.mjs
...
describe('Concierge policy integration — SkillRegistry + ConciergePolicyEvaluator', () => {
  const policy = new ConciergePolicyEvaluator({
