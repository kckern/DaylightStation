 ...
 * @module nutribot/domain/schemas
 * 
 * Validation schemas for NutriBot data structures.
 ...
 * @property {string} text - Original user input
 * @property {Meal} meal - Meal date and time
 * @property {FoodItem[]} items - Food items
 * @property {Object[]} questions - AI clarification questions
 * @property {NutritionSummary} nutrition - Calculated totals
 * @property {LogMetadata} metadata - Additional metadata
 * @property {string} createdAt - ISO timestamp
 * @property {string} updatedAt - ISO timestamp
 * @property {string|null} acceptedAt - ISO timestamp when accepted
 */
 ...
 * Validate a FoodItem
 * @param {any} item
 * @returns {{ valid: boolean, value?: FoodItem, errors?: string[] }}
 */
 ...
 * Validate a NutriLog
 * @param {any} log
 * @returns {{ valid: boolean, value?: NutriLog, errors?: string[] }}
 */
