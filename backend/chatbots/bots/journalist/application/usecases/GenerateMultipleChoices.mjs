...
import { buildMultipleChoicePrompt } from '../../domain/services/PromptBuilder.mjs';
    ...
    try {
      ...
      if (!Array.isArray(choices) || choices.length < 2) {
        ...
        const retryPrompt = [
          ...
          { role: 'user', content: 'Please respond with ONLY a JSON array of 4-6 answer options, like: ["Option 1", "Option 2", "Option 3", "Option 4"]' },
        ];
