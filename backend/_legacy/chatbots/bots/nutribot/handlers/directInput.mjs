...
function resolveUserContext(container, body, query = {}) {
  ...
  const botId = body.bot_id || query.bot_id || config.telegram?.botId || process.env.NUTRIBOT_TELEGRAM_BOT_ID || '6898194425';
  const userId = body.user_id || query.user_id || body.chat_id || query.chat_id || config.users?.defaultUserId || '575596036';
