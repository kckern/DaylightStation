 ...
 * Import from '#backend/src/0_infrastructure/http/httpClient.mjs' instead.
 *
 * Example:
 *   // Old (deprecated):
...
export * from '../../src/0_infrastructure/http/httpClient.mjs';
export { default } from '../../src/0_infrastructure/http/httpClient.mjs';
