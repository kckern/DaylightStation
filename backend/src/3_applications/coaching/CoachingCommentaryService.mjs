...
- Every day has a status. "complete", "done" and "fasting" totals are real. "incomplete" means meals are MISSING from the log — the total is not what was eaten. "unlogged" means no data.
