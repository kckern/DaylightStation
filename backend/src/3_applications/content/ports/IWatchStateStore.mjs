...
export function validateWatchStateStore(store) {
  if (typeof store.get !== 'function') {
    throw new Error('WatchStateStore must implement get(itemId, storagePath): Promise<WatchState|null>');
  }
  if (typeof store.set !== 'function') {
    throw new Error('WatchStateStore must implement set(watchState, storagePath): Promise<void>');
  }
