import { summariseUsage, formatDuration } from '#domains/gaming/services/arcadeGameUsage.mjs';
 ...
 */
export class SummariseArcadeGameUsage {
  #sessions; #logger;

  constructor({ sessions, logger = console }) {
    if (!sessions?.listSince) throw new Error('SummariseArcadeGameUsage requires a sessions repository with listSince');
...
export default SummariseArcadeGameUsage;
