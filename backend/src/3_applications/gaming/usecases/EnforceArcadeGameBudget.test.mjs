...
import { EnforceArcadeGameBudget } from './EnforceArcadeGameBudget.mjs';
...
const build = (grantedMs, over = {}) => new EnforceArcadeGameBudget({
...
describe('EnforceArcadeGameBudget — refuses to act without authority', () => {
...
describe('EnforceArcadeGameBudget — the warning ladder runs before anything is killed', () => {
...
describe('EnforceArcadeGameBudget — expiry', () => {
...
describe('EnforceArcadeGameBudget — construction', () => {
  it('requires the grant and terminator ports', () => {
    expect(() => new EnforceArcadeGameBudget({ terminator })).toThrow(/grants/);
    expect(() => new EnforceArcadeGameBudget({ grants: { forSession: async () => null } })).toThrow(/terminator/);
  });
});
