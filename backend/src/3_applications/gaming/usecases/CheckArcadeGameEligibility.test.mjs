...
import { CheckArcadeGameEligibility } from './CheckArcadeGameEligibility.mjs';

const quiet = { info() {}, warn() {} };
const tue16 = () => new Date('2026-09-15T16:00:00');
const build = (over = {}) => new CheckArcadeGameEligibility({ now: tue16, logger: quiet, ...over });

describe('CheckArcadeGameEligibility', () => {
...
describe('CheckArcadeGameEligibility — an input we cannot gather is not a refusal', () => {
