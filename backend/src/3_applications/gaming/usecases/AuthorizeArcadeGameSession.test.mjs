...
import { AuthorizeArcadeGameSession } from './AuthorizeArcadeGameSession.mjs';
...
const build = (confirm, over = {}) => new AuthorizeArcadeGameSession({
...
describe('AuthorizeArcadeGameSession — issuing', () => {
...
describe('AuthorizeArcadeGameSession — refusal is not silence', () => {
