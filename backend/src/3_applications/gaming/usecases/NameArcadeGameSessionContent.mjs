 ...
 */
export class NameArcadeGameSessionContent {
  ...
  async execute(session) {
    ...
    if (!content) {
      ...
      this.#logger.info?.('arcade.session.unknown_content', {
    ...
    this.#logger.info?.('arcade.session.named', {
...
export default NameArcadeGameSessionContent;
