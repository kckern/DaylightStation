...
import { GrantArcadeGameTime } from './GrantArcadeGameTime.mjs';
...
const build = () => new GrantArcadeGameTime({ ledger, today: () => '2026-09-11', logger: quiet });

beforeEach(() => { rows = []; });

describe('GrantArcadeGameTime', () => {
