...
export class IPlaySessionRepository {
  ...
  async listOpen() { throw new Error('IPlaySessionRepository.listOpen must be implemented'); }
  ...
  async listTrackedDeviceIds() { throw new Error('IPlaySessionRepository.listTrackedDeviceIds must be implemented'); }
  ...
  async hasReconciliationEvidence(_deviceId, _evidenceId) {
    throw new Error('IPlaySessionRepository.hasReconciliationEvidence must be implemented');
  }
  ...
  async markReconciliationEvidence(_deviceId, _evidence) {
    throw new Error('IPlaySessionRepository.markReconciliationEvidence must be implemented');
  }
}
