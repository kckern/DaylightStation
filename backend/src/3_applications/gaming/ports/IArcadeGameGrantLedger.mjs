 ...
 */
export class IArcadeGameGrantLedger {
  /** @returns {Promise<{grantedMs: number, entries: object[]}>} */
  async forUserOn(_userId, _isoDate) { throw new Error('IArcadeGameGrantLedger.forUserOn must be implemented'); }
  /** @returns {Promise<object>} the appended entry */
  async append(_userId, _isoDate, _entry) { throw new Error('IArcadeGameGrantLedger.append must be implemented'); }
}
