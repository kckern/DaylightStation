 ...
 */
export class IArcadeGameOverlay {
  /** @param {string} _deviceId @param {string} _url */
  async arm(_deviceId, _url) { throw new Error('IArcadeGameOverlay.arm must be implemented'); }
  /** Idempotent: clearing an already-clear device is not an error. */
  async disarm(_deviceId) { throw new Error('IArcadeGameOverlay.disarm must be implemented'); }
}
