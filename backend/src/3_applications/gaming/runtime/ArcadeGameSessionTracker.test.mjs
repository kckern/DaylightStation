...
import { ArcadeGameSessionTracker } from './ArcadeGameSessionTracker.mjs';
...
const intentFor = (overrides = {}) => new ArcadeGameSessionIntent({
...
const tracker = (over = {}) => new ArcadeGameSessionTracker({
...
describe('ArcadeGameSessionTracker — attribution', () => {
...
describe('ArcadeGameSessionTracker — recording health', () => {
...
describe('ArcadeGameSessionTracker — isolation and resilience', () => {
...
describe('ArcadeGameSessionTracker — scheduling', () => {
  ...
  it('refuses global timers — scheduling must be injected', () => {
    expect(() => new ArcadeGameSessionTracker({
