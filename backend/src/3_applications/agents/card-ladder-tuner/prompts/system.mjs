// backend/src/3_applications/agents/card-ladder-tuner/prompts/system.mjs
//
// Card-ladder tuning agent (mastery redesign §7). The digest in the user
