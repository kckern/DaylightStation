// backend/src/3_applications/agents/word-ladder-tuner/WordLadderTuner.mjs
/**
 * WordLadderTuner — a tool-less agent that reads one learner × package tuning
...
export class WordLadderTuner extends BaseAgent {
  static id = 'word-ladder-tuner';
  static description = 'Watches a learner\'s word-ladder days and nudges engine thresholds within grown-up bounds';
