...
export class RegradeBankAttempts {
  #datastore; #bankReader; #teacherGate; #learnerDirectory; #clock; #logger;

  constructor({ datastore, bankReader, teacherGate, learnerDirectory, clock = () => new Date(), logger = console } = {}) {
