...
import { AssertionCorrected, AssertionObserved, AssertionRetracted } from '../events/RequirementEvents.mjs';
...
function event(kind, assertion, occurredAt, extra = {}) {
  ...
  return new EventType({ assertionId: assertion.id, publisherId: assertion.publisherId, occurredAt, ...extra });
}
