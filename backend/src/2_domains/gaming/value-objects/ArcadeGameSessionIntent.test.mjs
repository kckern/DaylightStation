...
import { ArcadeGameSessionIntent } from './ArcadeGameSessionIntent.mjs';

const T0 = Date.parse('2026-09-11T20:00:00.000Z');
const at = (s) => new Date(T0 + s * 1000).toISOString();
const CONTENT = { contentId: 'game:a', title: 'Game A' };

const intent = (over = {}) => new ArcadeGameSessionIntent({
...
describe('ArcadeGameSessionIntent — it must name what it authorises', () => {
  it('requires content', () => {
...
describe('ArcadeGameSessionIntent — it must expire', () => {
...
describe('ArcadeGameSessionIntent — scope', () => {
...
describe('ArcadeGameSessionIntent — persistence', () => {
  it('round-trips through a snapshot', () => {
    const revived = ArcadeGameSessionIntent.fromSnapshot(intent().toSnapshot());
