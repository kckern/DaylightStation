...
/**
 * Translate the former broad School router dependency bag into the semantic
 * services the migrated router consumes. Production and tests both use this
 * composer so a test helper cannot silently repair wiring that app.mjs omits.
 */
export function createSchoolApiServices(legacy = {}) {
  const {
    ...
    schoolCurriculumQuery = null, schoolArtifactService = null,
    schoolApiSessions = null,
    ...options
  } = legacy;
...
export default createSchoolApiServices;
