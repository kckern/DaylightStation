...
// Piano MIDI→MP3 adapters + use case (daily render of piano/log into media/audio/piano)
...
export function createHarvesterServices(config) {
  ...
  // Piano MIDI→MP3 — daily render of every piano/log .mid into media/audio/piano.
