...
export function createAdminRequirementsRouter({ operations, actorFromRequest }) {
  if (!operations || !actorFromRequest) throw new Error('createAdminRequirementsRouter requires operations and actorFromRequest');
...
export default createAdminRequirementsRouter;
