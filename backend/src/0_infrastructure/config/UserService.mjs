...
/**
 * Lazy proxy for userService singleton.
 * Defers instance creation until first method call to avoid circular import issues.
 */
export const userService = new Proxy({}, {
  get(_, prop) {
