...
/**
 * Fans one arcade-game-session fact out to several announcers.
 *
 ...
 */
export class CompositeArcadeGameSessionAnnouncer extends IArcadeGameSessionAnnouncer {
  #announcers; #logger;
  ...
  async #each(kind, session, observation) {
    for (const announcer of this.#announcers) {
      try {
        ...
        this.#logger.warn?.('arcade.announce.member_failed', {
...
export default CompositeArcadeGameSessionAnnouncer;
