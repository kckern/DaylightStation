...
import { IComputeSandbox } from '#apps/agents/health-coach/ports/IComputeSandbox.mjs';
 ...
 */
export class ComputeSandboxAdapter extends IComputeSandbox {
  #timeoutMs;
...
export default ComputeSandboxAdapter;
