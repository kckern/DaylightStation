...
import { FullyKioskArcadeGameOverlay } from './FullyKioskArcadeGameOverlay.mjs';
...
const overlay = (over = {}) => new FullyKioskArcadeGameOverlay({
  clientsByDevice: new Map([['tv', client]]), httpClient: ok200, logger: quiet, ...over,
});

beforeEach(() => { sent = []; });

describe('FullyKioskArcadeGameOverlay — only declared devices', () => {
...
describe('FullyKioskArcadeGameOverlay — refuses to paint a broken page', () => {
...
describe('FullyKioskArcadeGameOverlay — teardown', () => {
