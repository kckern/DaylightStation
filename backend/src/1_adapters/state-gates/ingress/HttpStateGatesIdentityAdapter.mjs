export class HttpStateGatesIdentityAdapter {
  actorFromRequest(req) {
    ...
    if (!id) throw Object.assign(new Error('Authentication required'), { name: 'StateGatesApplicationError', code: 'UNAUTHENTICATED', status: 401 });
...
export default HttpStateGatesIdentityAdapter;
