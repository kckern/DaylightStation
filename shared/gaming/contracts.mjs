 ...
 *
 * This first wave deliberately exposes lifecycle states that look redundant in
 * a happy-path demo. They are the durable recovery seams for provider work that
 * will be filled in by later challenge implementations.
 */
export const GAMING_SCHEMA_VERSION = 1;
export const GAMING_ENGINE_VERSION = '0.4.0-card-game-campaign';
