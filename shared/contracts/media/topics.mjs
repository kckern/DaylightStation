...
export const COMMAND_HANDLER_PRESENCE_TOPIC = (deviceId) => `command-handler-presence:${deviceId}`;

const DEVICE_TOPIC_KINDS = ['device-state', 'device-ack', 'homeline', 'screen', 'command-handler-presence'];
