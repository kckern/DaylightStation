...
describe('YamlFinanceDatastore', () => {
  ...
  beforeEach(() => {
    ...
    const financesPath = path.join(testDataRoot, 'household', 'finances');
  ...
  describe('getBasePath', () => {
    it('returns correct path for default household', () => {
      ...
      expect(basePath).toBe(path.join(testDataRoot, 'household', 'finances'));
    });

    it('returns correct path for specified household', () => {
      const basePath = store.getBasePath('other');
      expect(basePath).toBe(path.join(testDataRoot, 'household-other', 'finances'));
    });
  });
