...
import { normalizeListItem, extractContentId, normalizeListConfig, serializeListConfig, applyCascade, denormalizeItem, INHERITABLE_FIELDS } from '#adapters/content/list/ListConfigCodec.mjs';
