...
const CHILD = { id: 'learner-two', name: 'learner-two', birthyear: THIS_YEAR - 9 };
...
const RETRY = {
  sessionId: 'ses_2', learnerId: 'learner-two', unitId: 'math-fractions.03',
...
const EVENTS = {
  ses_1: [
    { type: 'created', seq: 1, learnerId: 'learner-two', unitId: 'math-fractions.03' },
...
describe('SessionHistory — lineage', () => {
  ...
  it('defaults to the child on the roster, not the parent', async () => {
    renderHistory();
    await waitFor(() => expect(learnerSessionsMock).toHaveBeenCalledWith('learner-two'));
  });
});
