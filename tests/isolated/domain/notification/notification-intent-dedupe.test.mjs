...
import { serializeNotificationIntent } from '#adapters/notification/AppNotificationAdapter.mjs';
...
describe('NotificationIntent.dedupeKey', () => {
  it('stores and serializes an explicit dedupeKey', () => {
    ...
    expect(serializeNotificationIntent(i).dedupeKey).toBe('ceremony:unit_intention:2026-07-17');
  });
