...
//
// Stage screenshots for the word ladder's `/test` door (spec §8 Test mode):
...
// docs/reference/school/word-ladder.md for what each scenario seeds.
//
...
//
//   WORD_LADDER_TEST_LEARNER=<enrolled id> npx playwright test \
//     tests/live/flow/school/word-ladder-stage.runtime.test.mjs --reporter=line
//
