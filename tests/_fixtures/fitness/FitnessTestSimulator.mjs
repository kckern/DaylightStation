...
// These map to the actual devices in data/household/fitness/config.yml
...
// Real cadence device IDs from production config (data/household/fitness/config.yml)
...
// See: data/household/fitness/config.yml
