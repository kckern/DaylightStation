...
describe('Quiz Use Cases', () => {
  ...
  describe('SendQuizQuestion', () => {
    ...
    beforeEach(async () => {
      const module = await import(
        '../../../../../backend/src/3_applications/journalist/usecases/SendQuizQuestion.mjs'
      );
  ...
  describe('RecordQuizAnswer', () => {
    ...
    beforeEach(async () => {
      const module = await import(
        '../../../../../backend/src/3_applications/journalist/usecases/RecordQuizAnswer.mjs'
      );
  ...
  describe('HandleQuizAnswer', () => {
    ...
    beforeEach(async () => {
      const module = await import(
        '../../../../../backend/src/3_applications/journalist/usecases/HandleQuizAnswer.mjs'
      );
  ...
  describe('AdvanceToNextQuizQuestion', () => {
    ...
    beforeEach(async () => {
      const module = await import(
        '../../../../../backend/src/3_applications/journalist/usecases/AdvanceToNextQuizQuestion.mjs'
      );
