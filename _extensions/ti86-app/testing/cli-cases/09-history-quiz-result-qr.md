...
SCHOOLCALC_SCREEN label=down pc=019A executionWindow=true
T (1,1)-/c:SUBJECTS | (106,1)-/c:LEARNER1 | (10,10)+/c:MATH | (10,16)+/c:SCIENCE | (10,22)+/c:HISTORY | (10,28)+/c:ARTS & CULTURE | (4,58)-/c:OPEN | (30,58)-/c:BACK | (55,58)-/c:USER | (104,58)-/c:OFF; S (0,22)+:❯
G 2×8→Braille; swept text and chrome removed. + dark-on-light, - light-on-dark; c/r/d = 3×5/4×6/5×7.
...
T (1,1)-/c:WHY ROADS MATTER | (106,1)-/c:LEARNER1 | (10,10)+/c:NOTES | (10,16)+/c:EXAMPLES | (10,22)+/c:QUIZ | (4,58)-/c:OPEN | (30,58)-/c:BACK; S (0,10)+:❯
G 2×8→Braille; swept text and chrome removed. + dark-on-light, - light-on-dark; c/r/d = 3×5/4×6/5×7.
⠇⠇⠇⠇⠷⠳⠿⠿⠇⠞⠯⠮⠏⠎⠇⠮⠿⠶⠿⠿⠇⠅⠏⠎⠷⠰⠷⠰⠇⠶⠇⠆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠐⠾⠵⠽⠰⠻⠰⠾⠨⠸⠿
...
SCHOOLCALC_SCREEN label=down pc=019A executionWindow=true
T (1,1)-/c:WHY ROADS MATTER | (106,1)-/c:LEARNER1 | (10,10)+/c:NOTES | (10,16)+/c:EXAMPLES | (10,22)+/c:QUIZ | (4,58)-/c:OPEN | (30,58)-/c:BACK; S (0,16)+:❯
G 2×8→Braille; swept text and chrome removed. + dark-on-light, - light-on-dark; c/r/d = 3×5/4×6/5×7.
⠇⠇⠇⠇⠷⠳⠿⠿⠇⠞⠯⠮⠏⠎⠇⠮⠿⠶⠿⠿⠇⠅⠏⠎⠷⠰⠷⠰⠇⠶⠇⠆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠐⠾⠵⠽⠰⠻⠰⠾⠨⠸⠿
...
SCHOOLCALC_SCREEN label=down pc=019A executionWindow=true
T (1,1)-/c:WHY ROADS MATTER | (106,1)-/c:LEARNER1 | (10,10)+/c:NOTES | (10,16)+/c:EXAMPLES | (10,22)+/c:QUIZ | (4,58)-/c:OPEN | (30,58)-/c:BACK; S (0,22)+:❯
G 2×8→Braille; swept text and chrome removed. + dark-on-light, - light-on-dark; c/r/d = 3×5/4×6/5×7.
⠇⠇⠇⠇⠷⠳⠿⠿⠇⠞⠯⠮⠏⠎⠇⠮⠿⠶⠿⠿⠇⠅⠏⠎⠷⠰⠷⠰⠇⠶⠇⠆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠐⠾⠵⠽⠰⠻⠰⠾⠨⠸⠿
