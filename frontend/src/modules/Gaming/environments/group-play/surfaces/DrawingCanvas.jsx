...
import { DrawingTabletAdapter } from '../interaction/DrawingTabletAdapter.js';
...
export default function DrawingCanvas({ ink = '#111111', width = 6, cursor = 'crosshair', initialStrokes = [], onCheckpoint, onFinish }) {
  ...
  return <section className="group-play-drawing"><canvas ref={canvasRef} width={1280} height={720} aria-label="Drawing canvas" style={{ cursor }} />
