...
class FitnessModuleErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="fitness-module-error" style={{
          padding: '20px',
          textAlign: 'center',
          color: 'white',
          ...
          <div className="error-title" style={{ fontSize: '18px', fontWeight: 'bold', marginBottom: '8px' }}>Module Error</div>
          <div className="error-message" style={{ marginBottom: '24px', opacity: 0.8 }}>
            {this.props.manifest?.name || 'This module'} encountered an error.
          </div>
...
export default FitnessModuleErrorBoundary;
