...
- [FitnessModules/design.md](../design.md) - Module framework documentation
- [FitnessModules/CONTRIBUTING.md](../CONTRIBUTING.md) - How to build modules
...
- Register module in FitnessModules registry
