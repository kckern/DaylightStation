...
import { ActionBar, AppNavigation, AppList, ConfirmDialog, AppModal, MultiChoice, AppButton } from '@/modules/Fitness/shared';
import { DaylightMediaPath } from '@/lib/api.mjs';
import useFitnessModule from '@/modules/Fitness/player/useFitnessModule';
import ComponentCard from '../components/ComponentCard';

const CompositesSection = () => {
  const { participants = [], zones = [] } = useFitnessModule('component_showcase');
