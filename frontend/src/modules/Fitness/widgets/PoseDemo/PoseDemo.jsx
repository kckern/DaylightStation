/**
 * PoseDemo - Main module component for pose detection demonstration
 * 
 * Features:
...
import { PoseProvider } from '@/modules/Fitness/context/PoseContext.jsx';
import { usePoseProvider } from '@/modules/Fitness/hooks/usePoseProvider.js';
