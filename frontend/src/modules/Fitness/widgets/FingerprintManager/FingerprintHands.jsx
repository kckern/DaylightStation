...
// Fingertip pad coordinates (% of the square box) for the right hand as drawn.
// Calibrated against the rendered silhouette; left-hand tips mirror x → 100 - x.
const RIGHT_TIPS = {
  thumb: [22, 44],
  index: [41, 13],
  middle: [51, 9],
