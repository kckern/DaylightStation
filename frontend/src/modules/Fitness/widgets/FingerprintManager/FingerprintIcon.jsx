// Fingerprint glyph (svgrepo.com/471435/fingerprint-03, duplicate paths removed).
// Rendered with `currentColor` so it inherits the surrounding text color, and sized
// in `em` so it scales with the container's font-size (the module menu uses 48px).
import React from 'react';

export default function FingerprintIcon({ size = '1em', ...rest }) {
  return (
    <svg
      width={size}
      height={size}
