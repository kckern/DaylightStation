  ...
  for (let w = 0; w < weekCount; w += 1) {
    ...
    for (let d = 0; d < 7; d += 1) {
      ...
      cells[row * cols + col] = {
        ...
        // A day may name ITSELF — "Thanksgiving" rather than the state's
        // generic "a day off". Carried, never invented: judging stays outside
        // this module and so does naming.
