 ...
 * the card ladder's stage): poster left; class, unit, today and the deck's
...
export default function CardLadderStartCard({ intro, fallbackTitle, onStart, onPosterFailed }) {
