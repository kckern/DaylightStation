// usePianoScreensaverHooks.js — the screensaver/wake-lock hooks that consume
// PianoWakeLockContext and PianoScreenControlContext, split out of
// usePianoScreensaver.jsx (which keeps the two Providers) so Fast Refresh can
// hot-reload the providers without a full remount.
import { useContext, useCallback, useEffect, useRef } from 'react';
import getLogger from '../../../lib/logging/Logger.js';
import { DaylightAPI } from '../../../lib/api.mjs';
import { isWithinWindow } from './timeWindow.js';
import { PianoWakeLockContext, PianoScreenControlContext } from './usePianoScreensaver.jsx';
