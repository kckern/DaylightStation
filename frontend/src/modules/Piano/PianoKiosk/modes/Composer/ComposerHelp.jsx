...
// as a permanent reference after that. Closes on the ✕, the backdrop, or Escape.
  ...
  return (
    <div className="composer-help" role="dialog" aria-modal="true" aria-label="How to compose" onClick={onClose}>
      <div className="composer-help__panel" onClick={(e) => e.stopPropagation()}>
        <button type="button" className="composer-help__close" aria-label="Close" onClick={onClose}>✕</button>
