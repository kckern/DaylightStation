...
// the more specific rules above the generic ones. `\bbass\b` is a whole word so
// Contrabass and Bassoon stay with strings and winds; `\bbright\b` catches
// Bright Acoustic without pulling in the Brightness synth effect.
const RULES = [
  [/pian|grand|\bbright\b|clavichord|harpsichord|rhodes|wurl|honky/i, 'piano'],
  ...
  [/\bbass\b|guitar|banjo|ukulele|mandolin/i, 'family-guitar'],
  ...
  [/choir|voice|vocal|\baah|\booh/i, 'singalong'],
