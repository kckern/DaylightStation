 ...
 */
export function SeasonView({ parentId, contentId, depth, onSelect, onEscape, MENU_TIMEOUT = 0 }) {
  ...
  const { data, loading, error } = useFetchContentData(parentId, refetchKey, contentId);
