...
import { MantineProvider, Paper, Title, Group, Text, Alert, Badge, Stack, Card } from '@mantine/core';
...
const FitnessApp = () => {
  ...
  // Debug logging
  useEffect(() => {
    console.log(`🎯 FitnessApp: ${deviceCount} devices, connected: ${connected}`);
      ...
      <div className="fitness-app-container" >
        <div className="fitness-app-viewport">
          <Group position="apart" mb="md">
            <Title order={2} c="white">Fitness Monitor</Title>
            <Group>
              {deviceCount > 0 && (
          ...
          {!connected && (
            <Alert color="yellow" mb="md">
              <Text c="white">WebSocket disconnected - attempting to reconnect...</Text>
            </Alert>
          )}
