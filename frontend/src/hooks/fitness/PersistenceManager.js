  ...
  for (const [id, { startEvt, endEvt }] of challengeMap) {
    ...
    challengeEvents.push({
      ...
      data: {
        ...
        actualCount: e.actualCount ?? s.actualCount ?? null,
        equipmentId: s.equipmentId || e.equipmentId || null,
        metric: s.metric || e.metric || null,
        target: s.target ?? e.target ?? null,
        startCount: s.startCount ?? e.startCount ?? null,
        assignedUserId: e.assignedUserId || s.assignedUserId || null,
        stepsPerMinute: e.stepsPerMinute ?? s.stepsPerMinute ?? null,
        sensorOnline: e.sensorOnline ?? s.sensorOnline ?? null,
        reward: e.reward || s.reward || null,
