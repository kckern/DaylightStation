 ...
 * engines must independently agree: learner-one and parent-two are ghost occupants
...
describe('runSessionBackfill golden parity — session 20260627195941', () => {
  it('removes the two ghost occupants (learner-one, parent-two) and keeps grannie', () => {
    ...
    expect([...result.removedOccupants].sort()).toEqual(['learner-one', 'parent-two']);
